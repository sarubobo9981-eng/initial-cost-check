  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-12 sm:px-6">
      ...
      <div className="mt-6 space-y-6 text-sm leading-relaxed text-slate-700">
        ...
        <section>
          <h2 className="font-semibold text-slate-900">4. 見積書解析における外部サービスの利用</h2>
          <p className="mt-2">
            本サービスの見積書解析機能では、お客様がアップロード・撮影された見積書の内容を読み取るため、外部の各種サービスを利用する場合があります。
          </p>
          <ul className="mt-2 list-disc space-y-1 pl-5">
            <li>
              見積書には、物件名・金額のほか、氏名・住所等の情報が記載されている場合があります。解析のために必要な範囲で、これらを含む画像・PDFデータを外部サービスへ送信することがあります。
            </li>
            <li>
              解析処理には、Anthropic社が提供するAPI（Claude）を利用する場合があります。
            </li>
            <li>
              アップロードされたファイルは、解析処理のためVercel社が提供するストレージサービス（Vercel Blob）へ一時的に保存する場合があります。この保存はアクセス制限がかけられた状態で行われ、解析が完了次第、速やかに削除する運用としています。
            </li>
            <li>
              解析に使用したファイルは、当サービス側では原則として永続的に保存しません。ただし、外部サービス事業者側でのデータの取扱い（保持期間・利用目的等）については、当社が完全に制御できるものではなく、各社が公表する規約・プライバシーポリシーに従います。最新の内容は各社の公式情報をご確認ください。
            </li>
            <li>
